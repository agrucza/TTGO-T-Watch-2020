...
enum UIESize_t : uint8_t {
    ...
    FULL_GAP_LEFT_TOP,      // this will require an extra parameter sizeGap
    FULL_GAP_BOTTOM_RIGHT,  // this will require an extra parameter sizeGap
    FULL_GAP_BOTH,          // this will require an extra parameter sizeGap
};
